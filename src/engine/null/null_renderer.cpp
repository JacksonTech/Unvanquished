...
void R_DrawDebugLine(Vec3 start, Vec3 end, float width, Vec4 color) {}
void R_DrawDebugSphere(Vec3 center, float radius, Vec4 color) {}
...
refexport_t    *GetRefAPI( int apiVersion, refimport_t *rimp )
{
    ...
    re.DrawDebugLine = R_DrawDebugLine;
    re.DrawDebugSphere = R_DrawDebugSphere;
